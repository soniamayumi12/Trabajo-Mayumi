...
int main() {
    ...
    return 0;
} // MODIFICAR SI EL TOTAL DE ENTRADAS "GENERALES "VENDIDAS SUPERA LOS 600 ENTONCES SERA RECONOCIDO COMO CLIENTE ESTRELLA Y SE LE OTORGA UN DESCUENTO DEL 15% EN SU
// SU PROXIMA COMPRA
